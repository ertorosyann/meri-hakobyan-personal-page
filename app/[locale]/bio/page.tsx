    ...
    <div className="bio-page">
      ...
      <div className="bio-container">
        <div className="bio-content">
          <h2 className="bio-title">About Merri Hakobyan</h2>
          <p className="bio-text">
            Merri Hakobyan is a <span className="bio-highlight">celebrated Armenian singer</span> known for her 
          ...
          <p className="bio-text">
            Throughout her career, she has collaborated on numerous projects,{' '}
            <Link href={`/${locale}/tv-serials`} className="bio-text-link">television programs</Link>, and{' '}
            <Link href={`/${locale}/teatre`} className="bio-text-link">musical performances</Link>{' '}
            that have touched the hearts of countless fans. Her dedication to preserving 
          ...
          {achievements.map((achievement, index) => (
            ...
            >
              <div className="achievement-card">
                ...
                <div className="achievement-link-arrow">
        ...
        <div className="timeline">
          ...
          <div className="timeline-items">
            <div className="timeline-item">
              <div className="timeline-content">
                <div className="timeline-year">
                  <Link href={`/${locale}/songs`} className="timeline-link">Early Career</Link>
                </div>
            ...
            <div className="timeline-item">
              <div className="timeline-content">
                <div className="timeline-year">
                  <Link href={`/${locale}/tv-serials`} className="timeline-link">Television</Link>
                </div>
                <p className="timeline-text">
            ...
            <div className="timeline-item">
              <div className="timeline-content">
                <div className="timeline-year">
                  <Link href={`/${locale}/teatre`} className="timeline-link">Live Performances</Link>
                </div>
                <p className="timeline-text">
